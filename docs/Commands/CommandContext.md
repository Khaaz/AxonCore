...
| executionState | <code>COMMAND\_EXECUTION\_STATE</code> |  | The state of execution (no error, cooldown, invalid usage, invalid permission) |
| executionType | <code>COMMAND\_EXECUTION\_TYPES</code> |  | The type of execution (Owner, Admin, Regular) |
...
| [callerID] | <code>String</code> | <code></code> | Context: user that called the command ID |
| [callerName] | <code>String</code> | <code></code> | Context: user that called the command name |
...
* [CommandContext](#CommandContext)
    ...
    * _static_
        ...
        * [.getExecutionType(isAdmin, isOwner)](#CommandContext.getExecutionType) ⇒ <code>COMMAND\_EXECUTION\_TYPES</code>
...
<a name="CommandContext+raw"></a>

### commandContext.raw : <code>String</code>
...
| [data.helpExecution] | <code>Boolean</code> | <code>false</code> |  |
| [data.executionState] | <code>COMMAND\_EXECUTION\_STATE</code> | <code>0</code> | no error, cooldown, invalid usage, invalid permissions... |
| [data.executionType] | <code>COMMAND\_EXECUTION\_TYPES</code> | <code>0</code> | Regular, admin, owner execution |
| [data.dm] | <code>Boolean</code> | <code>false</code> |  |

<a name="CommandContext.getExecutionType"></a>

### CommandContext.getExecutionType(isAdmin, isOwner) ⇒ <code>COMMAND\_EXECUTION\_TYPES</code>
